...
export const productosHC = [
        ...
        { id:"9", nombre:"Lirio de Agua", "descripcion":"es una planta que pertenece a la familia de las Aráceas y es originaria de Sudáfrica, más precisamente de la región del Cabo. Su nombre científico es Zantedeschia aethiopica y, además de los nombres anteriores, en algunos lugares también es conocida como Alcatraz, Aro de Etiopía y Cartucho.", precio:"540", img: Lirio, cantidad:"1", tipo: "palustre" },
        ...
        { id:"11", nombre:"Sagitaria subulata", "descripcion":"Conocida como sagittaria enana es una planta tapizante de crecimiento rápido y fácil mantenimiento. Es similar a las Echinodorus tenellus con hojas mas grandes, pero la sagittaria puede crecer en acuarios con iluminación mas moderada y sin adición de Co2. Definitivamente una planta apta para casi cualquier acuario, permitiendo tapizar todo el frente sin espacios libres.", precio:"430", img: Sagitariasubulata, cantidad:"1", tipo: "fondo" },
        { id:"12", nombre:"Echinodorus", "descripcion":"Las Echinodorus forman un grupo de plantas de grandes dimensiones que se emplean para personalizar zonas determinadas del acuario debido a su gran porte. No se colocan formando grupos ya que además de por su tamaño compiten entre ellas por los nutrientes. Por lo general ocupan el plano medio del acuario no empleándose como plantas de fondo a pesar de su porte.", precio:"500", img: Echinodorus, cantidad:"1", tipo: "fondo" },
    ];
